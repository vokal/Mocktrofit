...
/**
 * An implementation of of {@link OutputStream} that can produce
...
public class BencodingOutputStream extends FilterOutputStream 
  ...
  /**
   * Returns the charset that is used to encode {@link String}s.
  ...
  /**
   * Bencode does not support null but you may override this method 
   * to implement a custom version. The default implementation throws
   * an {@link IOException}.
   */
  ...
  /**
   * Overwrite this method to write custom objects. The default
   * implementation throws an {@link IOException}.
   */
